...
function desenhaTabela() {
  ...
  tabela.forEach(function (item) {
    ...
    feitoCell.appendChild(verificaFeito(item.feito, item.id)); //! novo
    progressoCell.textContent = verificaProgresso(item.feito, item.data);
    //! novo

    removerCell.appendChild(desenhaBotaoRemover(item.id)); //! novo
  });
}
...
function desenhaBotaoRemover(id) {
